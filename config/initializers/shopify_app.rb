ShopifyApp.configure do |config|
  ...
  config.webhooks = [
      { topic: 'app/uninstalled', address: "#{Settings.api_url}/webhooks/app_uninstalled", format: 'json' },
      { topic: 'shop/update', address: "#{Settings.api_url}/webhooks/shop_update", format: 'json' },
  ]
